...
func NewRouter(rh *handler.RequestHandler) *gin.Engine {
	...
	protected.GET("/page/my/calendars/list", rh.GetMyCalenders)
	...
	protected.GET("/bookings", rh.GetBookings)
	protected.POST("/bookings", rh.SaveBooking)
	protected.GET("/my/bookings", rh.GetMyBookings)
	protected.GET("/bookings/received", rh.GetReceivedBookings)
